...
# --- ASOSIY SAHIFA (FANLARNI TANLASH) ---
    ...
    # Murat yuborgan fanlar ro'yxati
    ...
    if st.session_state.get('test_started'):
        ...
        quiz_data = {
            "PYTHON": [
                ...
                {"q": "O'zgarmas ro'yxat turi nima deyiladi?", "o": ["tuple", "list", "set", "dictionary"],
                 "a": "tuple"},
            ...
            "Differensial tenglamalar": [
                ...
                {"q": "Chiziqli differensial tenglamaning tartibi nimaga bog'liq?",
                 "o": ["Yuqori hosilaga", "Erkli o'zgaruvchiga", "Yechim soniga", "Integralga"],
                 "a": "Yuqori hosilaga"},
                ...
                {"q": "y'' + w^2y = 0 tenglamaning yechimi?",
                 "o": ["Sinus/Kosinus", "Eksponenta", "Logarifm", "Polinom"], "a": "Sinus/Kosinus"},
            ...
            "Moliyaviy savodxonlik": [
                {"q": "Inflyatsiya nima?", "o": ["Narx oshishi", "Narx tushishi", "Soliq", "Qarz"],
                 "a": "Narx oshishi"},
                ...
                {"q": "Budjet nima?",
                 "o": ["Kirim va chiqim rejasi", "Faqat daromad", "Soliq yig'indisi", "Bank hisobi"],
                ...
                {"q": "Aktsiya nima?",
                 "o": ["Ulishli qimmatli qog'oz", "Qarz qog'ozi", "Soliq kvitansiyasi", "Shartnoma"],
        ...
        for i, q in enumerate(current_questions):
            st.write(f"**{i + 1}. {q['q']}**")
            ans = st.radio(f"Javobni tanlang:", q['o'], key=f"ans_{option}_{i}")
